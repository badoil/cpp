...
// 다음 M개 줄에는 구간 [1, 10의 9제곱]에 포함되는 양의 정수가 하나씩 주어진다. K번째 줄에 주어지는 숫자는 K번 색상 보석의 개수이다.
...
// 선형적으로 탐색했을때 시간복잡도가 초과될거 같으면
// 이분탐색을 생각하라

// 조건, 학생은 항상 같은 색상의 보석만 가져간다
...
// 질문! 이분탐색으로 풀면, 보석을 학생수만큼 제대로 나눠줄 수 있는가?