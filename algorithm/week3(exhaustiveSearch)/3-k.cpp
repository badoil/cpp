...
// 이 문제는 큐를 두개씩 쓰는 문제
// 백조와 물의 움직임(얼음 녹이기)을 구현
// 백조가 움직이고 얼음 만나면 백조 움직임 끝내고
// 그 얼음을 물의 움직임으로 녹인 다음에
// 백조와 물 움직임의 임시 큐들을 큐로 스왑하고 다시 시작
// 이 한턴을 날짜로 카운트해서 출력

// moveSwan은 물을 만나면 계속 이동해야하므로 swanQ에 푸시를하지만
// meltWater는 하루 단위로 끊어가기 때문에 waterQ에 다시 푸시 안함